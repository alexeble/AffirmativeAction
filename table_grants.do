...
reghdfe fund_amount_deflated treat_female_post `controls' if `cond1', absorb(author_numid2 year) vce(cluster author_numid2) 
...
texdoc init "$table_path/Tab_grants.tex", replace force
...
tex & & & & & \\
tex \multicolumn{6}{c}{\textbf{Panel C: Total amount of funding earned (person-by-year-level, unit: 10,000 CNY)}}
tex & & & & & \\
tex `tex_te' \\
tex `tex_se' \\
tex & & & & & \\

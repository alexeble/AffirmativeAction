...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.1)) ///
	...
	omitted ///
	legend(order(2 "Fields with higher female rep." 4 "Fields with lower female rep.") pos(6) region(lstyle(solid)) cols(2) symxsize(*1.5) size(4)) ///
	xlabel(,labsize(4)) ///
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to full professor", size(4))

graph export "$figure_path\Fig_full_prof_1966_1975_field_het.eps", replace
graph export "$figure_path\Fig_full_prof_1966_1975_field_het.pdf", replace	
...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.1)) ///
	...
	coeflabels(years_n5="-5" years_n4=" " years_n3=" " years_n2=" " year_cutoff=" " ///
		...
		years_p5="5" years_p6=" " years_p7=" " years_p8=" " years_p9=" " years_p10="10") ///
	omitted ///
	legend(order(2 "Science fields" 4 "Engineering fields") pos(6) region(lstyle(solid)) cols(2) symxsize(*1.5) size(4)) ///
	xlabel(,labsize(4)) ///
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to full professor", size(4))

graph export "$figure_path\Fig_full_prof_1966_1975_field2_het.eps", replace
graph export "$figure_path\Fig_full_prof_1966_1975_field2_het.pdf", replace	
...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.1)) ///
	...
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to assoc professor", size(4))

graph export "$figure_path\Fig_assoc_prof_1966_1975_field_het.eps", replace
graph export "$figure_path\Fig_assoc_prof_1966_1975_field_het.pdf", replace	
...
graph export "$figure_path\Fig_assoc_prof_1966_1975_field2_het.eps", replace
graph export "$figure_path\Fig_assoc_prof_1966_1975_field2_het.pdf", replace	
...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.1)) ///
	...
	coeflabels(years_n5="-5" years_n4=" " years_n3=" " years_n2=" " year_cutoff=" " ///
		...
		years_p5="5" years_p6=" " years_p7=" " years_p8=" " years_p9=" " years_p10="10") ///
	omitted ///
	legend(order(2 "Higher-performing scientists" 4 "Lower-performing scientists") pos(6) region(lstyle(solid)) cols(2) symxsize(*1.5) size(4)) ///
	xlabel(,labsize(4)) ///
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to full professor", size(4))

graph export "$figure_path\Fig_full_prof_1966_1975_ability_het.eps", replace
graph export "$figure_path\Fig_full_prof_1966_1975_ability_het.pdf", replace	
...
graph export "$figure_path\Fig_assoc_prof_1966_1975_ability_het.eps", replace
graph export "$figure_path\Fig_assoc_prof_1966_1975_ability_het.pdf", replace	
...
graph export "$figure_path\Fig_assoc_prof3_1966_1975_ability_het.eps", replace
graph export "$figure_path\Fig_assoc_prof3_1966_1975_ability_het.pdf", replace	
...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.1)) ///
	...
	coeflabels(years_n5="-5" years_n4=" " years_n3=" " years_n2=" " year_cutoff=" " ///
		...
		years_p5="5" years_p6=" " years_p7=" " years_p8=" " years_p9=" " years_p10="10") ///
	omitted ///
	legend(order(2 "High-tier universities" 4 "Lower-tier universities") pos(6) region(lstyle(solid)) cols(2) symxsize(*1.5) size(4)) ///
	xlabel(,labsize(4)) ///
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to full professor", size(4))

graph export "$figure_path\Fig_full_prof_1966_1975_rank_het.eps", replace
graph export "$figure_path\Fig_full_prof_1966_1975_rank_het.pdf", replace	
...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.15)) ///
	...
	coeflabels(years_n5="-5" years_n4=" " years_n3=" " years_n2=" " year_cutoff=" " ///
		...
		years_p5="5" years_p6=" " years_p7=" " years_p8=" " years_p9=" " years_p10="10") ///
	omitted ///
	legend(order(2 "Elite univ." 4 "Key univ." 6 "Other univ.") pos(6) region(lstyle(solid)) cols(3) symxsize(*1.5) size(4)) ///
	xlabel(,labsize(4)) ///
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to full professor", size(4))

graph export "$figure_path\Fig_full_prof_1966_1975_3rank_het.eps", replace
graph export "$figure_path\Fig_full_prof_1966_1975_3rank_het.pdf", replace	
...
graph export "$figure_path\Fig_assoc_prof_1966_1975_rank_het.eps", replace
graph export "$figure_path\Fig_assoc_prof_1966_1975_rank_het.pdf", replace	
...
graph export "$figure_path\Fig_assoc_prof2_1966_1975_rank_het.eps", replace
graph export "$figure_path\Fig_assoc_prof2_1966_1975_rank_het.pdf", replace	
...
graph export "$figure_path\Fig_assoc_prof_1966_1975_3rank_het.eps", replace
graph export "$figure_path\Fig_assoc_prof_1966_1975_3rank_het.pdf", replace	
...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.1)) ///
	...
	coeflabels(years_n5="-5" years_n4=" " years_n3=" " years_n2=" " year_cutoff=" " ///
		...
		years_p5="5" years_p6=" " years_p7=" " years_p8=" " years_p9=" " years_p10="10") ///
	omitted ///
	legend(order(2 "Laboratory fields" 4 "Desk fields") pos(6) region(lstyle(solid)) cols(2) symxsize(*1.5) size(4)) ///
	xlabel(,labsize(4)) ///
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to full professor", size(4))

graph export "$figure_path\Fig_full_prof_1966_1975_lab_het.eps", replace
graph export "$figure_path\Fig_full_prof_1966_1975_lab_het.pdf", replace	


/* ---------------------------------------------------- */
/*          assoc professor: cohorts [1966, 1975]       */
/*                   lab vs. desk fields                */
/* ---------------------------------------------------- */
...
graph export "$figure_path\Fig_assoc_prof_1966_1975_lab_het.eps", replace
graph export "$figure_path\Fig_assoc_prof_1966_1975_lab_het.pdf", replace	
*/
...
graph export "$figure_path\Fig_full_prof_1966_1975_ability2_het.eps", replace
graph export "$figure_path\Fig_full_prof_1966_1975_ability2_het.pdf", replace	
...
graph export "$figure_path\Fig_assoc_prof_1966_1975_ability2_het.eps", replace
graph export "$figure_path\Fig_assoc_prof_1966_1975_ability2_het.pdf", replace	
...
coefplot (grant1, msymbol(O) mcolor(gs0) lcolor(gs0) ciopts(recast(rcap) lcolor(gs0) lpattern(solid)) offset(-0.22)) ///
	...
	coeflabels(years_n5="-5" years_n4=" " years_n3=" " years_n2=" " year_cutoff=" " ///
		...
		years_p5="5" years_p6=" " years_p7=" " years_p8=" " years_p9=" " years_p10="10") ///
	omitted ///
	legend(order(2 "High-ability scholars + top-tier univ." 4 "High-ability scholars + lower-tier univ." ///
		6 "Lower-ability scholars + top-tier univ." 8 "Lower-ability scholars + lower-tier univ.") ///
		pos(6) region(lstyle(solid)) cols(2) symxsize(*1.5) size(4)) ///
	xlabel(,labsize(4)) ///
	ylabel(-0.08(0.04)0.04,labsize(4)) ///
	xtitle("Distance to year 2011", size(4)) ///
	ytitle("Likelihood of promotion to full professor", size(4))
